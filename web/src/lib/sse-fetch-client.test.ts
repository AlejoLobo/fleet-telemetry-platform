...
describe("sse-fetch-client FT-001", () => {
  ...
  it("SseParser interpreta connected, fleet-update, alert y heartbeat", () => {
    ...
    const payload = [
      ...
      "",
      "event: fleet-update",
      'data: [{"deviceId":"00000000-0000-4000-8000-000000000001","vehicleName":"VH-001","status":"online"}]',
      "",
      "event: alert",
      'data: {"alertId":"a1","deviceId":"00000000-0000-4000-8000-000000000001","alertType":"overspeed","severity":"critical","message":"x","createdAt":"2026-07-11T00:00:00Z","isAcknowledged":false}',
      "",
      "event: heartbeat",
      'data: {"status":"ok"}',
      "",
