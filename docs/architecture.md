...
- **SSE:** modo **KafkaPush** por defecto (`fleet.realtime` → API → SSE). Modo alternativo: polling a TimescaleDB (`FleetSsePollerHostedService`). Ver [realtime-sse.md](realtime-sse.md).
